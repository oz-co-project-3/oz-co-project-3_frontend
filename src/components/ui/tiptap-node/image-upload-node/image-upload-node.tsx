...
const ImageUploadDragArea: React.FC<ImageUploadDragAreaProps> = ({ onFile, children }) => {
  ...
  return (
    <div
      className={`tiptap-image-upload-dragger ${dragover ? 'tiptap-image-upload-dragger-active' : ''} rounded-md border border-dashed border-gray-300`}
      onDrop={onDrop}
  ...
  <>
    ...
    <div className='tiptap-image-upload-content'>
      <span className='tiptap-image-upload-text'>
        <em>클릭하여 업로드</em> 또는 끌어다 놓기
      </span>
      <span className='tiptap-image-upload-subtext'>최대 파일 크기 {maxSize / 1024 / 1024}MB.</span>
    </div>
  </>
);
